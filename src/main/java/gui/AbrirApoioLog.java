 ...
 * @author jhonatan
 */
public class AbrirApoioLog extends javax.swing.JFrame {

    /**
     * Creates new form AbrirApoioLog
     */
    private AbrirApoioLog() {
        initComponents();
    ...
    private static AbrirApoioLog aal;

    public static synchronized AbrirApoioLog getInstance() {
        if (aal == null) {
            aal = new AbrirApoioLog();
        }
        return aal;
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Qualidade do serviço", "Adequação IF", "Perc. Objetivo", "Críticas e Sug."
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (rowIndex != -1) {
            AbrirEvento.al = AbrirEvento.mtal.get(rowIndex);
            int jop = JOptionPane.showConfirmDialog(null, "Confirma a exclusão?");
            if (jop == JOptionPane.YES_OPTION) {
                if (AbrirEvento.alCrud.deletar(AbrirEvento.al)) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (buttonGroup1.getSelection() != null && buttonGroup2.getSelection() != null
            ...
            AbrirEvento.al = new Apoio_logistico();
            ...
            if (AbrirEvento.alCrud.inserir(AbrirEvento.al)) {
    ...
    public void editar() {
        ...
        if (rowIndex != -1) {
            AbrirEvento.al = AbrirEvento.mtal.get(rowIndex);
            eal = EditarApoioLog.getInstance();

            UtilOptions.converterSet(AbrirEvento.al.getQualidade(), eal.buttonGroup1);
            UtilOptions.converterSet(AbrirEvento.al.getAdequacao(), eal.buttonGroup2);
            eal.jTextField1.setText(AbrirEvento.al.getPercentual_obj());
            eal.jTextArea1.setText(AbrirEvento.al.getCriticas_sug());
            eal.setVisible(true);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbrirApoioLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbrirApoioLog().setVisible(true);
            }
        });
    }
